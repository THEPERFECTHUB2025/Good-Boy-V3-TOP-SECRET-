...
local getForceHit = nil -- Fonction pour récupérer l'état de ForceHit
...
function SilentAimModule:Enable(getForceHitFunc)
    ...
    -- Vérifier que la fonction pour récupérer ForceHit est fournie
    ...
    old = hookmetamethod(game, "__index", function(self, key)
        if not checkcaller() and SilentAimEnabled and SilentAimTarget and typeof(self) == "Instance" and self:IsA("Mouse") and key == "Hit" then
