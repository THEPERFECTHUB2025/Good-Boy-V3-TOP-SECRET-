...
local function UpdateTargetInfoUI()
    ...
    if not getgenv().Rake.Settings.Misc.TargetInfoEnabled or not ForceHitModule.ManuallyEnabled or not ForceHitModule.TargetPlayer then
    ...
    ui.WeaponLabel.Text = equippedWeapon or ""
...
-- Initialisation des paramètres (à appeler avant d'utiliser le toggle)
...
getgenv().Rake.Settings.Misc.TargetInfoEnabled = true -- Activé par défaut
