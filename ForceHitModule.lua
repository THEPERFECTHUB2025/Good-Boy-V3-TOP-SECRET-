...
-- Section TargetStrafe modifiée pour gérer les HP de la cible
ForceHitModule.Connections["TargetStrafe"] = RunService.Heartbeat:Connect(function(deltaTime)
    ...
    -- Si les HP sont à 20 ou plus, activer le TargetStrafe
    if targetHealth >= 20 then
        ForceHitModule.TargetStrafeActive = true
    end

    -- Si TargetStrafeActive est false (HP entre 0.5 et 20), ne rien faire
