...
local function CreateTargetInfoUI()
    ...
    local function createEnergyParticle()
        local particle = Instance.new("Frame")
...
local function UpdateTargetInfoUI()
    ...
    if distance <= 10 then
        for i = 1, 2 do
            local createEnergyParticle = ui.EnergyParticleFrame.Parent.Parent.Parent.Parent.Parent.CreateTargetInfoUI.createEnergyParticle
