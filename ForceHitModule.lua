...
-- Modification de la section TargetStrafe pour supprimer la restriction de distance de 200 mètres
ForceHitModule.Connections["TargetStrafe"] = RunService.Heartbeat:Connect(function(deltaTime)
    ...
    local distance = (localRootPart.Position - targetRootPart.Position).Magnitude
    -- On garde uniquement la limite maximale de 100 000 mètres, comme demandé
    if distance > 100000 then -- Distance maximale de 100 000 studs
        return
    end
