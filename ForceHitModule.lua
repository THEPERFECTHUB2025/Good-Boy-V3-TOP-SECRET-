...
local ForceHitModule = {
    ...
    LastKillAllTime = 0,
    StrafeAngle = 0, -- Will no longer be used for circling
    Tracer = nil,
    Attachment0 = nil,
    Attachment1 = nil,
    TargetInfoUI = nil,
...
-- Modified KillAll to stick to the target instead of circling
ForceHitModule.Connections["KillAll"] = RunService.Heartbeat:Connect(function()
    ...
    if localRootPart and targetRootPart then
        ...
        -- Position the local player 2 studs behind the target, facing them
        local offset = Vector3.new(0, 0, -2) -- 2 studs behind
        local newPosition = targetRootPart.Position + (targetRootPart.CFrame.LookVector * offset.Z)
...
-- Modified TargetStrafe to stick to the target instead of circling
ForceHitModule.Connections["TargetStrafe"] = RunService.Heartbeat:Connect(function()
