...
local function UpdateTracer()
    ...
    -- Si ForceHit n'est pas activé ou s'il n'y a pas de cible, ne rien faire
    ...
    if not localRootPart or not targetRootPart then
        print("Tracer: Personnage ou cible non valide")
        return
    end

    -- Créer le Beam (Tracer)
    local tracer = Instance.new("Beam")
    tracer.Name = "ForceHitTracer"
    tracer.Parent = game.CoreGui -- Placer le Beam dans CoreGui pour qu'il soit visible
