...
local ForceHitModule = {
    ...
    ToolSupportEnabled = false, -- Nouvelle option pour activer le support de l'outil
    BlankShots = true,
    HitPart = "Head",
...
local function CreateForceHitTool()
    ...
    tool.Activated:Connect(function()
        -- Vérifier si le toggle ForceHit est activé dans l'UI
