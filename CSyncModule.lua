...
local function runCSync()
    ...
    -- Met à jour la positionVposition de la caméra
    CameraPart.Position = originalCFrame.Position + Vector3.new(0, 2, 0) -- Correction ici
...
local function setKeybind(keyCode)
    ...
    if typeof(keyCode) == "EnumItem" and keyCode.EnumType == Enum.KeyCode then
        ...
        print("Touche de toggle mise à jour: " .. keyCode.Name)
    else
